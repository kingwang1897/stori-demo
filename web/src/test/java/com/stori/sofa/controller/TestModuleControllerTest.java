 ...
 **/
public class TestModuleControllerTest extends BaseTest {
    ...
    public void testMySql() throws Exception {
        // 测试桩
        Mockito.when(billFacade.getBill()).thenReturn(Result.ok("true"));

        MvcResult mvcResult =
            mockMvc.perform(MockMvcRequestBuilders.get("/test/module").accept(MediaType.APPLICATION_JSON))
