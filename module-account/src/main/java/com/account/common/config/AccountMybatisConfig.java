...
public class AccountMybatisConfig implements EnvironmentAware {
    ...
    public SqlSessionFactoryBean mysqlSqlSessionFactory1(@Autowired @Qualifier("accountDataSource") DataSource dataSource) throws Exception {
    ...
    public MapperScannerConfigurer mysqlMapperScanner(@Autowired @Qualifier("accountSqlSessionFactory") SqlSessionFactoryBean sqlSessionFactory) throws Exception {
